    ...
    public class Program
    {
        ...
        public static void hardDifficulty(ref bool gameRunning, char[,] maze, User user, Bullet userBullet)
        {
            ...
            while (gameRunning)
            {
                ...
                {
                    gameRunning = Enemys.moveGrandpa(ref direction, maze, ref Enemys.grandpaX, ref Enemys.grandpaY, user);
                ...
                {
                    gameRunning = Enemys.moveGrandpa(ref dir1, maze, ref Enemys.grandpa2X, ref Enemys.grandpa2Y, user);
                    if (gameRunning == false)
                    {
                        break;
                    }
                ...
                gameRunning = Enemys.moveGhostRandom(maze, ref Enemys.granny2X, ref Enemys.granny2Y, user);
                if (gameRunning == false)
                {
                    break;
                }
                if (Insects.insect2Move != false)
                {
                    gameRunning = Insects.moveInsect(ref insectDir1, maze, ref Insects.insect2X, ref Insects.insect2Y);
                }
                if (Insects.insectMove != false)
                {
                    gameRunning = Insects.moveInsect1(maze, ref Insects.insectX, ref Insects.insectY, ref insectDir2);
                }
                Bullet.bulletCollisionWithInsect2(maze, ref Insects.insect2X, ref Insects.insect2Y, ref Insects.insect2Move);
                Bullet.bulletCollisionWithInsect1(maze, ref Insects.insectX, ref Insects.insectY, ref Insects.insectMove);

                gameRunning = Enemys.moveGranny(maze, ref Enemys.grannyX, ref Enemys.grannyY, ref previous, user);
                gameRunning = Insects.collisionwithInsects(ref gameRunning, ref Insects.insect2X, ref Insects.insect2Y, ref Insects.insectX, ref Insects.insectY, user);
